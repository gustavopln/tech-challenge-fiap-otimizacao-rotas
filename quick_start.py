...
# from models import Entrega, Veiculo, Base, PrioridadeEntrega
# from medical_genetic_algorithm import calculate_fitness_with_constraints, generate_priority_biased_population
